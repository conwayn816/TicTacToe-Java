...
public abstract class Player {
    ...
    protected boolean valid(int choice) {
        ...
        switch (choice) {
            case 1:
                val = (board[0][0] != "X" && board[0][0] != "O");
                break;
            case 2:
                val = (board[0][1] != "X" && board[0][1] != "O");
                break;
            case 3:
                val = (board[0][2] != "X" && board[0][2] != "O");
                break;
            case 4:
                val = (board[1][0] != "X" && board[1][0] != "O");
                break;
            case 5:
                val = (board[1][1] != "X" && board[1][1] != "O");
                break;
            case 6:
                val = (board[1][2] != "X" && board[1][2] != "O");
                break;
            case 7:
                val = (board[2][0] != "X" && board[2][0] != "O");
                break;
            case 8:
                val = (board[2][1] != "X" && board[2][1] != "O");
                break;
            case 9:
                val = (board[2][2] != "X" && board[2][2] != "O");
                break;
            default:
                val = false;
                break;
