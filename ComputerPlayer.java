        ...
        public void TakeTurn(Player othPlayer) {
                ...
                for (int i = 1; i < 10; i++) {
                        ...
                        if (valid(i)) {
                                ...
                                if (CheckWinner()) {
                                        System.out.println(
                                                        "Player " + GetTurn() + " (computer) chooses postion " + (i));
                                        return;
                                }
                ...
                for (int i = 1; i < 10; i++) {
                        ...
                        if (valid(i)) {
                                switch (i) {
                                        case 1:
                                                board[0][0] = othPlayer.letter;
                                                break;
                                        case 2:
                                                board[0][1] = othPlayer.letter;
                                                break;
                                        case 3:
                                                board[0][2] = othPlayer.letter;
                                                break;
                                        case 4:
                                                board[1][0] = othPlayer.letter;
                                                break;
                                        case 5:
                                                board[1][1] = othPlayer.letter;
                                                break;
                                        case 6:
                                                board[1][2] = othPlayer.letter;
                                                break;
                                        case 7:
                                                board[2][0] = othPlayer.letter;
                                                break;
                                        case 8:
                                                board[2][1] = othPlayer.letter;
                                                break;
                                        case 9:
                                                board[2][2] = othPlayer.letter;
                                                break;
                                }

                                // if it works block that move
                                if (CheckWinner()) {
                                        System.out.println("Player " + GetTurn() + " (computer) chooses postion "
                                                        + (i + 1));
                                        switch (i) {
                                                case 1:
                                                        board[0][0] = letter;
